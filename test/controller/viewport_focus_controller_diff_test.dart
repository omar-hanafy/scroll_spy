...
void main() {
  group('ViewportFocusController - diff-only notifications', () {
    ...
    test(
      ...
      () {
        ...
        const id = 7;
        final ValueListenable<ViewportItemFocus<int>> listenable =
        ...
        final a = const ViewportItemFocus<int>(
          id: id,
          isVisible: true,
          isFocused: true,
          isPrimary: true,
        ...
        controller.commitFrame(
          makeSnapshot(
            ...
            focusedIds: <int>{id},
            visibleIds: <int>{id},
            items: <int, ViewportItemFocus<int>>{id: a},
          ),
        );
        ...
        final b = const ViewportItemFocus<int>(
          id: id,
          isVisible: true,
          isFocused: true,
          isPrimary: true,
        ...
        controller.commitFrame(
          makeSnapshot(
            ...
            focusedIds: <int>{id},
            visibleIds: <int>{id},
            items: <int, ViewportItemFocus<int>>{id: b},
          ),
        );
        ...
        controller.commitFrame(
          makeSnapshot(
            ...
            focusedIds: <int>{id},
            visibleIds: <int>{id},
            items: <int, ViewportItemFocus<int>>{id: c},
          ),
        );
      ...
      () {
        ...
        controller.commitFrame(
          makeSnapshot(
            ...
            focusedIds: <int>{id},
            visibleIds: <int>{id},
            items: <int, ViewportItemFocus<int>>{id: focus},
          ),
        );
