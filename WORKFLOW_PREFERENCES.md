...
- Publishing is executed inside the auto-release workflow; manual fallback is running `publish.yml` via workflow_dispatch with the tag input (ex: `scroll_spy-v1.2.3`).
