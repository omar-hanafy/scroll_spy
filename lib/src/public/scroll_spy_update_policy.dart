...
@immutable
sealed class ScrollSpyUpdatePolicy {
  const ScrollSpyUpdatePolicy();
  ...
  const factory ScrollSpyUpdatePolicy.perFrame() = PerFrameUpdatePolicy;
  ...
  const factory ScrollSpyUpdatePolicy.onScrollEnd({Duration debounce}) =
  ...
  const factory ScrollSpyUpdatePolicy.hybrid({
...
/// or `distanceToAnchor`.
@immutable
final class PerFrameUpdatePolicy extends ScrollSpyUpdatePolicy {
  /// Creates a per-frame update policy.
  const PerFrameUpdatePolicy();

  @override
  String toString() => 'ScrollSpyUpdatePolicy.perFrame()';
}
...
@immutable
final class OnScrollEndUpdatePolicy extends ScrollSpyUpdatePolicy {
  ...
  @override
  String toString() => 'ScrollSpyUpdatePolicy.onScrollEnd(debounce: $debounce)';
}
...
@immutable
final class HybridUpdatePolicy extends ScrollSpyUpdatePolicy {
  ...
  @override
  String toString() => 'ScrollSpyUpdatePolicy.hybrid('
