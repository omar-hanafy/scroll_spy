...
///
/// This logic is applied *after* the policy (`ScrollSpyPolicy`) ranks
...
class ScrollSpyStability {
  ...
  /// between items.
  const ScrollSpyStability.disabled()
      : hysteresisPx = 0.0,
  ...
  bool operator ==(Object other) {
    return other is ScrollSpyStability &&
